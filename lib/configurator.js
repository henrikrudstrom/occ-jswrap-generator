...
function builtInModule() {
  ...
  mod.name = 'builtins';
  mod.members.push(new configuration.Builtin('Number', 'Standard_Real'));
  mod.members.push(new configuration.Builtin('Number', 'Standard_Integer'));
  mod.members.push(new configuration.Builtin('Boolean', 'Standard_Boolean'));
  return mod;
}
