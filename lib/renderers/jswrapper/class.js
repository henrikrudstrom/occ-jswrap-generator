...
class ClassRenderer extends base.ContainerRenderer {
    ...
    return `\
      ...
      namespace ${this.def.parent.name} {
        ...
        public:
          ...
          ${this.renderEmptyCtorDeclaration()}
          ${ptrCtor}
          ${valueCtor}
        protected:
  ...
  renderEmptyCtorImplementation() {
    return `${this.def.qualifiedName}::${this.def.name}() {}`;
  }
  ...
  renderImplementationFile() {
    ...
    ${this.renderEmptyCtorImplementation()}
    ${ptrCtor}
    ${valueCtor}
