...
const MethodOverloadConfiguration = require('./overload.js').MethodOverload;
...
class ConstructorConfiguration extends CallableConfiguration {
  static wrap(parent, queryOrObject) {
    let constructors = [];
    ...
    return new ConstructorConfiguration('New', constructors, 'constructorOverload');
  }
}
