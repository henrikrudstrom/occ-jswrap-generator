...
var defaultsettings = {
  ...
  oce: {
    ...
    parseToolkits: [
      'TKG3d', 'TKG2d', 'TKernel', 'TKMath',
      'TKGeomBase', 'TKBRep', 'TKPrim', 'TKGeomAlgo', 'TKTopAlgo', 'TKFillet'
      //'TKBool', 'TKShHealing', 'TKAdvTools', 'TKBO'
    ]
  },
  xmlGenerator: 'gccxml',
...
function initialize(settings) {
  ...
  settings.paths = extend({}, settings.paths, {
    src: path.join(settings.paths.build, 'src'),
